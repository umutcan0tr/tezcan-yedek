...
module.exports.run = async (client, msg, args) => {
  ...
  if (
    ...
    try {
      ...
      const embed = new Discord.RichEmbed()
        .setColor("RANDOM")
        .setAuthor(
          `Minecraft - Oyun bilgileri`,
          "https://img00.deviantart.net/9cc9/i/2011/008/6/1/minecraft_hd_icon___mac___pc_by_hunterkharon-d36qrs5.png"
        )
        .setURL(`http://minecraft.net/`)
        .setThumbnail("https://i.ytimg.com/vi/SQq6IDdBNGk/maxresdefault.jpg")
        .addField(
          "Oyun fiyatı",
          "[23,95 EUR](https://minecraft.net/tr-tr/?ref=m)"
        )
        ...
        .addField(
          "Geliştiriciler",
          "Mojang Inc, Microsoft Corporation" || "Bulunamadı"
        )
  ...
  try {
    ...
    const embed = new Discord.RichEmbed()
      ...
      .addField(
        "Meta puanı",
        data.metacritic ? data.metacritic.score : "Bulunamadı"
      )
      .addField(
        "Önerilme sayısı",
        data.recommendations ? data.recommendations.total : "Bulunamadı"
      )
      .addField("Platform", platforms.join(", ") || "Bulunamadı")
      .addField("Yayınlanma tarihi", data.release_date.date || "Bulunamadı")
      .addField("Dlc sayısı", data.dlc ? data.dlc.length : "0")
      .addField(
        "Geliştiriciler",
        data.developers
          ? data.developers.join(", ") || "Bulunamadı"
          : "Bulunamadı"
      )
      .addField(
        "Yayıncılar",
        data.publishers
          ? data.publishers.join(", ") || "Bulunamadı"
          : "Bulunamadı"
      );
    return msg.channel.send(embed);
  } catch (err) {
